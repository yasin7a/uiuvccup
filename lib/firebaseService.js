...
export const userService = {
  ...
  async createTeamOwner(email, teamName) {
    try {
      // Generate a random password for later use
      ...
      console.error('Error creating team owner record:', error);
      throw error;
    }
  },
  ...
  async loginTeamOwner(email, password) {
    try {
      ...
      if (querySnapshot.empty) {
        console.log('❌ Team owner not found:', email);
        return null;
      }
      ...
      if (userData.generatedPassword === password) {
        console.log('✅ Team owner credentials valid:', email);
        return {
          uid: userDoc.id,
        ...
        console.log('❌ Invalid password for team owner:', email);
        return null;
      }
    } catch (error) {
      console.error('Error checking team owner credentials:', error);
      return null;
    }
  },
